...
import labels, sed, modularized_model_main, tar_to_record, export, parse_hyperparams
...
def main():
    ...
    tar_to_record.main(DATASET_PATH, '/opt/ml/input/data/training/')
    ...
    export.main(TRAIN_STEPS, OUTPUT_PATH, NAME)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ptm', '--checkpoint', help='The name of the model you wish to retrain', type=str,
                        default='mobilenet_v2_ssd')
    parser.add_argument('-dsp', '--dataset', help='The path to the dataset', type=str,
                        default='/opt/ml/input/data/training/full_data.tar')
    parser.add_argument('-ep', '--eval_period', help='How many epochs to run before running another evaluation',
